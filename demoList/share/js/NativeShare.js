!function(e, t){
  ...
  return function(e){
    ...
    var ae, ce = navigator.userAgent, ue = /(iPad).*OS\s([\d_]+)/.test(ce), le = /(iPod)(.*OS\s([\d_]+))?/.test(ce), fe = !ue && /(iPhone\sOS)\s([\d_]+)/.test(ce), se = ue || le || fe, pe = /(Android);?[\s\/]+([\d.]+)?/.test(ce), he = /micromessenger/i.test(ce), be = /QQ\/([\d\.]+)/.test(ce), ye = /Qzone\//.test(ce), de = /MQQBrowser/i.test(ce) && !he && !be, we = /UCBrowser/i.test(ce), ve = /mobile.*baidubrowser/i.test(ce), ge = /SogouMobileBrowser/i.test(ce), me = /baiduboxapp/i.test(ce), _e = {
    ...
    var Be = Ue, Re = function(){
      ...
      return K(t, e), ot(t, [{
        key: "setShareData", value: function(e){
          ...
          try{
            mqq.data.setShareInfo({share_url: n.link, title: n.title, desc: n.desc, image_url: n.icon}, function(e){
              !0 !== e && console.warn(e)
            })
          }catch(e){
          }
